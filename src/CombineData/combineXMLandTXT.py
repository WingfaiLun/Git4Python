...
if __name__ == '__main__':
    ...
    sheet1 = [[u"文章号", u"文章主题", u"年份", u"地区（国家）", u"期刊名", "Journal-ab", u"第一作者", u"合作作者", u"第一单位", u"合作单位", u"关键词", u"摘要", "Language", "PublicationType", "MedlineJournalCOUNTRY", u"作者-机构", u"通讯作者", u"作者-机构1"]]
